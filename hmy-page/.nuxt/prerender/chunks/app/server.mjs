import { version, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, hasInjectionContext, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, withCtx, nextTick, defineComponent, h, Suspense, Transition } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/vue/index.mjs';
import { $fetch } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/h3/dist/index.mjs';
import { renderSSRHead } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/@unhead/ssr/dist/index.mjs';
import { getActiveHead, createServerHead as createServerHead$1 } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/@unhead/shared/dist/index.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, useRoute as useRoute$1, RouterView } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/vue-router/dist/vue-router.node.mjs';
import { hasProtocol, parseURL, joinURL } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///workspaces/MartinFeineis.github.io/hmy-page/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a9cc06b6.mjs').then((m) => m.default || m)
  },
  {
    name: "message",
    path: "/message",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/message-daa2944c.mjs').then((m) => m.default || m)
  }
];
