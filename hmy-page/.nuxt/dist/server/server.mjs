...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-a9cc06b6.js").then((m) => m.default || m)
  },
  {
    name: "message",
    path: "/message",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/message-daa2944c.js").then((m) => m.default || m)
  }
];
